...
const resolveIncidents = async (data) => {
    try {
        const response = await axios_1.apiInstance.post(`/v3/incidents/resolve`, {
        ...
        return (0, text_1.default)(`All incidents resolved successfully.`);
    }
    catch (error) {
        console.error(error);
...
exports.default = resolveIncidents;
