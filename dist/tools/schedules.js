...
const listSchedules_1 = __importDefault(require("../services/schedules/graphql/listSchedules"));
const zod_1 = __importDefault(require("zod"));
const createSchedule_1 = __importDefault(require("../services/schedules/graphql/createSchedule"));
const initSchedulesTools = (server) => {
    server.tool("whoIsOnCall", "Get the user(s) who is currently on call.", {}, whoIsOnCall_1.default);
    server.tool("listSchedules", "Get a list of schedules.", {
        query: zod_1.default.string().describe(`The GraphQL query to execute.
...
query{
  schedules(filters:{
    ...
    }, listSchedules_1.default);
    server.tool("createSchedule", "Create a schedule given a name, time zone, and rotations. ", {
        query: zod_1.default.string().describe(`The GraphQL query to execute.
